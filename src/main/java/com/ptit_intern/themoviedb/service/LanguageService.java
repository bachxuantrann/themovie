...
public interface LanguageService {
    ...
    void updateLanguage(@Valid LanguageDTO languageDTO) throws InvalidExceptions;

    ResultPagination searchLanguages(int page, int size, String keyword, boolean desc);
}
